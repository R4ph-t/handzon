declare module "@clack/prompts" {
  ...
  export function text(opts: { message: string; placeholder?: string; defaultValue?: string; validate?: (v: string) => string | undefined }): Promise<string | symbol>;
  export function confirm(opts: { message: string; initialValue?: boolean }): Promise<boolean | symbol>;
  export function select(opts: { message: string; options: Array<{ value: string; label?: string }> }): Promise<string | symbol>;
